...
from network import init_model, init_adam, init_datagen
from parameters import build_sherpa_augmentations_space
from train import train

if __name__ == "__main__":

    algorithm = 'gpyopt-augs-only'
    ...
    # Baseline setup
    params = build_sherpa_augmentations_space()
    baseline_params = {
    ...
    for trial in study:
        ...
        meta_cols = ['dropout', 'batch_size', 'max_epochs', 'depth', 'dense_neurons', 'init_filters',
                     'use_batchnorm', 'learning_rate', 'beta1', 'beta2', 'zoom', 'width_shift', 'height_shift',
